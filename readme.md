...
Student ID: B00894651

Email: kaila.hamawi@dal.ca
...
Change: I added an id to the form and button element, as well as a div for the two main containers.

Reason for change: I added an id to make it easier to target in JavaScript and CSS. I added the div to act as a wrapper for better layout flexibility and styling. Most styling could have been achieved by targeting the existing elements, but my changes enhance the clarity, make it more straightforward, and improve styling and functionality.
